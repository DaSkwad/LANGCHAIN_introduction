...
Ce projet propose une introduction pédagogique à l'utilisation de **LangChain**, une bibliothèque permettant de créer des applications basées sur des modèles de langage (LLMs).  
